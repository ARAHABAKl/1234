...
window.onload = hideCartCountIfEmptyBasket();
...
function checkingActiveButtons(basket) {
    ...
    buttons.forEach(btn => {
        ...
        btn.textContent = isInBasket ? 'В корзине' : 'Добавить в корзину';
    });
}
		...
		const cardItem = 
			`
                <div class="card" data-product-id="${id}">
                    ...
                    <p id=${id}" class="card__title">${title}</p>
